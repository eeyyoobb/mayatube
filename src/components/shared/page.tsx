...
//import QuizzesArea from '@/components/Components/QuizzesArea';
import Start from '../../app/(routes)/quizzes/quiz-start/page'
...
//   };
  ...
  return (
    <div className="flex flex-col md:flex-row w-full bg-black border border-gray-200 h-svh">
        {/* <Navbar/>
         <QuizzesArea/>  */}
         <Start/>
      {/* sidebar */}
