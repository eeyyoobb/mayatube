const themes = [
  {
    ...
    colorGT: "linear-gradient(110.42deg, #FFD700 66.2%, #FFEB3B 23.56%)",
    colorBrand: "#FFD700",
    colorBlur: "rgba(255, 255, 255, 0.2)",
    colorGY: "linear-gradient(110.42deg, #FFD700 29.2%, #FFEB3B 63.56%)",
    colorGl1: "rgba(255, 255, 255, 0.15)",
    colorGL2: "rgba(255, 255, 255, 0.25)", 
    colorGL3: "rgba(255, 255, 255, 0.1)",
    borderColor: "rgba(255, 255, 255, 0.25)",
    shadow: "1px 7px 12px rgba(255, 215, 0, 0.4)", 
    colorIcons: "rgba(255, 255, 255, 0.35)", 
    colorIcons2: "rgba(255, 255, 255, 0.75)",
